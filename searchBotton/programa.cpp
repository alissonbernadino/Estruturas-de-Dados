...
int main()
{
  ...
  do
  {
    ...
    else if (opcao == 2)
    {
      ...
      cin >> peso;
      grafo1.setAresta(item1, item2, peso);
    }
    else if (opcao == 3)
    {
    ...
    else if (opcao == 7)
    {
      ...
      cin >> item2;
      grafo1.procuraLargura(item1, item2);
    }
    else if (opcao == 8)
    {
      cout << "Digite o vertice de origem:\n";
      ...
      cout << "Digite o vertice de destino:\n";
      cin >> item2;
      grafo1.procuraProfundidade(item1, item2);
    }
  } while (opcao != 0);
